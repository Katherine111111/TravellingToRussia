...
# Characters
# -------------------------------
define guide = Character("**Guide**", color="#3289bb")
...
# -------------------------------
# --- Guide sprites ---
image guide pointing = im.FactorScale("images/characters/guidepointing.png", 1.5)
image guide sad = im.FactorScale("images/characters/guidesad.png", 1.5)
image guide standing = im.FactorScale("images/characters/guidestanding.png", 1.5)
image guide standing2 = im.FactorScale("images/characters/guidestanding2.png", 1.5)
image guide thinking = im.FactorScale("images/characters/guidethinking.png", 1.5)
image guide thumbsup = im.FactorScale("images/characters/guidethumbsup.png", 1.5)
...
label start:
    ...
    guide "Hello! You won a trip across Russia. What's your name?"
